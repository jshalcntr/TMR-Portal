...
<head>
    ...
    <title>E-BOSS - Deleted Backorders</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between align-items-center">
                        <h1 class="h3 mb-2 text-gray-800">Deleted Backorders</h1>
                        <div class="d-flex align-items-center">
                            ...
                            <a href="deletedBackorders.php" class="btn btn-sm btn-primary shadow-sm mr-2"><i class="fas fa-trash fa-sm"></i> Deleted Backorder</a>
                            ...
                            <button class="btn btn-sm btn-primary shadow-sm ml-2" id="exportBtn">
                        ...
                        <div class="card-body">
                            <div class="alert alert-info">
                                ...
                                <div class="btn-group ms-3" role="group">
                                    ...
                                    <button class="btn btn-sm btn-danger" id="bulkPermanentDeleteBtn">
...
<script src="../../assets/js/e-boss/deletedBackorders.js"></script>

                ...
                <div class="modal-body custom-scrollable-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="row justify-content-center align-items-start g-2 mt-0">
                                    <div class="col-12 col-md-4 form-group">
                                        <label for="province_updateBP" class="mb-0 flex-grow-1">Province:</label>
                                        <!-- <select name="province" id="province_updateBP" class="form-select form-select-sm" required></select> -->
                                        <p class="fs-5 fw-bold" id="province_updateBP">Province</p>
                                    </div>
                                    <div class="col-12 col-md-4 form-group">
                                        ...
                                        <p class="fs-5 fw-bold" id="municipality_updateBP">Municipality</p>
                                    </div>
                                    <div class="col-12 col-md-4 form-group">
                                        ...
                                        <p class="fs-5 fw-bold" id="barangay_updateBP">Barangay</p>
                                    </div>
                                </div>
                                <div class="row justify-content-center align-items-center">
                                    ...
                                    <p class="fs-5 fw-bold" id="street_updateBP">Street Address</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="row justify-content-center align-items-center">
                                    ...
                                    <p class="fs-5 fw-bold" id="contactNumber_updateBP">Contact Number</p>
                                </div>
                            </div>
                            <div class="row">
                                <p class="form-label">Client Gender:</p>
                                <p class="fs-5 fw-bold" id="gender_updateBP">Client Gender</p>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <label for="birthday_updateBP" class="form-label">Date of Birth</label>
                                <div class="row d-flex form-group gap-2">
                                    <input type="date" name="birthday" id="birthday_updateBP" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <p class="fs-4 fw-bold" id="inquiryDate_updateBP">Date of Inquiry</p>
                            </div>
                            <div class="row">
                                <label class="form-label">Source of Inquiry: </label>
                                <p class="fs-4 fw-bold" id="inquirySource_updateBP">Source of Inquiry</p>
                                <!-- <div class="row d-flex form-group gap-2">
                            ...
                            <div class="row d-none" id="f2fSourceRow_updateBP">
                                <label for="f2fSource_updateBP" class="form-label">Face To Face Inquiry Source: </label>
                                <p class="fs-4 fw-bold" id="f2fSource_updateBP">Face To Face Inquiry Source</p>
                                <!-- <div class="row d-flex form-group gap-2">
                            ...
                            <div class="row d-none" id="onlineSourceRow_updateBP">
                                <label for="onlineSource_updateBP" class="form-label">Online Inquiry Source: </label>
                                <p class="fs-4 fw-bold" id="onlineSource_updateBP">Online Inquiry Source</p>
                                <!-- <div class="row d-flex form-group gap-2">
                            ...
                            <div class="row d-none" id="mallDisplayRow_updateBP">
                                <label for="mallDisplay_updateBP" class="form-label">Mall Display: </label>
                                <p class="fs-4 fw-bold" id="mallDisplay_updateBP">Mall Display</p>
                                <!-- <div class="row d-flex form-group gap-2">
                            ...
                            <div class="row">
                                ...
                                <div class="row d-flex form-group gap-2">
                                    <label for="appointmentDate_updateBP">Next Call Date <span class="text-danger" id="appointmentDateRequired_updateBP">*</span></label>
                                    <input type="date" name="appointmentDate" id="appointmentDate_updateBP" class="form-control form-control-sm" required>
                                </div>
                                <div class="row d-flex form-group gap-2">
                                    <label for="appointmentTime_updateBP" class="mb-0 flex-grow-1">Next Call Time <span class="text-danger" id="appointmentTimeRequired_updateBP">*</span></label>

<!-- Modal -->
<div class="modal fade" id="createSubProfilingModal" tabindex="-1" aria-labelledby="createSubProfilingModalLabel" aria-hidden="true">
                ...
                <form id="createSubprofilingForm" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col form-group">
                            ...
                            <input type="text" name="csNumber" id="csNumber" class="form-control form-control-sm" required>
                        </div>
                        <div class="col form-group">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col form-group">
                            ...
                            <select name="jobLevel" id="jobLevel" class="form-select form-select-sm" required title="Address where the client works or where their business is located" required>
                                ...
                                <option value="jnrStaff">Junior Staff</option>
                                <option value="snrStaff">Senior Staff</option>
                                <option value="spvr">Supervisorial</option>
                                <option value="asstManager">Assistant Manager</option>
                                <option value="manager">Manager</option>
                                <option value="snrManager">Senior Manager</option>
                                <option value="topManger">Top Manager</option>
                            </select>
                        </div>
                    </div>
                    <div class="row justify-content-center align-items-center">
                        <div class="col form-group">
                            ...
                            <select name="workNature" id="workNature" class="form-select form-select-sm" required>
                                ...
                                <option value="businessNature">Business</option>
                    ...
                    <div id="businessSizeRow" class="row justify-content-center align-items-center d-none">
                        <div class="col form-group">
                            ...
                            <select name="businessSize" id="businessSize" class="form-select form-select-sm" required>
                    ...
                    <div id="technicalRow" class="row justify-content-center align-items-center d-none">
                        <div class="col form-group">
                            <label for="technicalReleaseDate" class="form-label">Technical Release Date</label>
                            <input type="date" class="form-control form-control-sm" id="technicalReleaseDate" name="technicalReleaseDate">
                        </div>
                    </div>
                    <div class="row justify-content-center align-items-center">
                        <div class="col form-group">

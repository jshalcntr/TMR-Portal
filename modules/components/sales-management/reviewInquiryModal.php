<div class="modal fade" id="reviewInquiryModal" tabindex="-1" aria-labelledby="reviewInquiryModalLabel" aria-hidden="true" data-bs-backdrop="static">
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="row justify-content-center align-items-center g-2">
                                    ...
                                    <div class="col-12 col-md-4 form-group">
                                        <label for="barangay_review" class="mb-0 flex-grow-1">Barangay</label>
                                        <select name="barangay" id="barangay_review" class="form-select form-select-sm" disabled></select>
                                    </div>
                                </div>
                                <div class="row justify-content-center align-items-center">
                            ...
                            <div class="row">
                                ...
                                <div class="row d-flex form-group gap-2">
                                    <input type="date" name="birthday" id="birthday_review" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <div class="row d-flex form-group gap-2">
                                    <label for="appointmentDate_review">Next Call Date <span class="text-danger">*</span></label>
                                    <input type="date" name="appointmentDate" id="appointmentDate_review" class="form-control form-control-sm" required>
                                </div>
                                <div class="row d-flex form-group gap-2">
                                    <label for="appointmentTime_review" class="mb-0 flex-grow-1">Next Call Time <span class="text-danger">*</span></label>

            ...
            <div class="modal-content">
                ...
                <div class="row modal-body custom-scrollable-body">
                    <div class="col">
                        ...
                        <div class="row">
                            <label for="birthday_updateN" class="form-label">Date of Birth <span class="text-danger" id="birthdayRequired_updateN">*</span></label>
                            <div class="row d-flex form-group gap-2">
                                <input type="date" name="birthday" id="birthday_updateN" class="form-control form-control-sm" required>
                            </div>
                        </div>
                        <div class="row">
                    ...
                    <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="row d-flex form-group gap-2">
                                <label for="appointmentDate_updateN">New Appintment Date <span class="text-danger" id="appointmentDateRequired_updateN">*</span></label>
                                <input type="date" name="appointmentDate" id="appointmentDate_updateN" class="form-control form-control-sm" required>
                            </div>
                            <div class="row d-flex form-group gap-2">
                                <label for="appointmentTime_updateN" class="mb-0 flex-grow-1">New Appointment Time <span class="text-danger" id="appointmentTimeRequired_updateN">*</span></label>

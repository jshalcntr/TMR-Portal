            ...
            <div class="modal-body custom-scrollable-body">
                <form id="createNewGroupForm" class="container needs-validation" novalidate autocomplete="off">
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="groupName" class="col-form-label">Group Initials</label>
                                <input type="text" name="groupName" id="groupName" class="form-control form-control-sm" minlength="3" maxlength="3" required>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="groupNumber" class="col-form-label">Group Number</label>
                                <input type="number" name="groupNumber" id="groupNumber" class="form-control form-control-sm" required>
                                <div class="invalid-feedback">
                    ...
                    <div class="row mt-2">
                        <div class="col">
                            <div class="d-flex justify-content-end actions-group">
                                <button class="btn btn-sm shadow-sm btn-primary" type="submit"><i class="fas fa-users-viewfinder"></i> Create Group</button>
                            </div>
                        </div>
                    </div>
                </form>

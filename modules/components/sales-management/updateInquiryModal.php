<div class="modal fade" id="updateInquiryModal" tabindex="-1" aria-labelledby="updateInquiryModalLabel" aria-hidden="true" data-bs-backdrop="static">
                ...
                <div class="modal-body custom-scrollable-body">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="row">
                                <p class="fs-5 mb-0">Customer Name</p>
                                <div class="row justify-content-center align-items-start">
                                    <div class="col form-group">
                                        ...
                                        <p class="fs-5 fw-bold" id="customerFirstName_update">First Name</p>

                                    </div>
                                    <div class="col form-group">
                                        <label>Middle Name: </label>
                                        <!-- <input type="text" name="customerMiddleName" id="customerMiddleName_update" class="form-control form-control-sm"> -->
                                        <p class="fs-5 fw-bold" id="customerMiddleName_update">Middle Name</p>
                                    </div>
                                    <div class="col form-group">
                                        <label>Last Name: </label>
                                        <!-- <input type="text" name="customerLastName" id="customerLastName_update" class="form-control form-control-sm" required> -->
                                        <p class="fs-5 fw-bold" id="customerLastName_update">Last Name</p>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <p class="fs-5 mb-0">Client Address</p>
                                <div class="row justify-content-center align-items-start g-2 mt-0">
                                    <div class="col-12 col-md-4 form-group">
                                        <label for="province_update" class="mb-0 flex-grow-1">Province:</label>
                                        <!-- <select name="province" id="province_update" class="form-select form-select-sm" required></select> -->
                                        <p class="fs-5 fw-bold" id="province_update">Province</p>
                                    </div>
                                    <div class="col-12 col-md-4 form-group">
                                        <label class="mb-0 flex-grow-1">Municipality:</label>
                                        <!-- <select name="municipality" id="municipality_update" class="form-select form-select-sm" disabled required></select> -->
                                        <p class="fs-5 fw-bold" id="municipality_update">Municipality</p>
                                    </div>
                                    <div class="col-12 col-md-4 form-group">
                                        <label class="mb-0 flex-grow-1">Barangay:</label>
                                        <!-- <select name="barangay" id="barangay_update" class="form-select form-select-sm" disabled required></select> -->
                                        <p class="fs-5 fw-bold" id="barangay_update">Barangay</p>
                                    </div>
                                </div>
                                <div class="row justify-content-center align-items-center">
                                    <label class="mb-0 flex-grow-1">Street Address:</label>
                                    <!-- <input type="text" name="street" id="street_update" class="form-control form-control-sm"> -->
                                    <p class="fs-5 fw-bold" id="street_update">Street Address</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="row justify-content-center align-items-center">
                                    ...
                                    <p class="fs-5 fw-bold" id="contactNumber_update">Contact Number</p>
                                </div>
                            </div>
                            <div class="row">
                                <p class="form-label">Client Gender:</p>
                                <p class="fs-5 fw-bold" id="gender_update">Client Gender</p>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <label for="birthday_update" class="form-label">Date of Birth</label>
                                <div class="row d-flex form-group gap-2">
                                    <input type="date" name="birthday" id="birthday_update" class="form-control form-control-sm">
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="col">
                            ...
                            <div class="row">
                                ...
                                <p class="fs-4 fw-bold" id="inquiryDate_update">Date of Inquiry</p>
                            </div>
                            <div class="row">
                                <label class="form-label">Source of Inquiry: </label>
                                <p class="fs-4 fw-bold" id="inquirySource_update">Source of Inquiry</p>
                                <!-- <div class="row d-flex form-group gap-2">
                            ...
                            <div class="row d-none" id="f2fSourceRow_update">
                                <label for="f2fSource_update" class="form-label">Face To Face Inquiry Source: </label>
                                <p class="fs-4 fw-bold" id="f2fSource_update">Face To Face Inquiry Source</p>
                                <!-- <div class="row d-flex form-group gap-2">
                            ...
                            <div class="row d-none" id="onlineSourceRow_update">
                                <label for="onlineSource_update" class="form-label">Online Inquiry Source: </label>
                                <p class="fs-4 fw-bold" id="onlineSource_update">Online Inquiry Source</p>
                                <!-- <div class="row d-flex form-group gap-2">
                            ...
                            <div class="row d-none" id="mallDisplayRow_update">
                                <label for="mallDisplay_update" class="form-label">Mall Display: </label>
                                <p class="fs-4 fw-bold" id="mallDisplay_update">Mall Display</p>
                                <!-- <div class="row d-flex form-group gap-2">
                            ...
                            <div class="row">
                                ...
                                <div class="row d-flex form-group gap-2">
                                    <label for="appointmentDate_update">Next Call Date <span class="text-danger" id="appointmentDateRequired_update">*</span></label>
                                    <input type="date" name="appointmentDate" id="appointmentDate_update" class="form-control form-control-sm" required>
                                </div>
                                <div class="row d-flex form-group gap-2">
                                    <label for="appointmentTime_update" class="mb-0 flex-grow-1">Next Call Time <span class="text-danger" id="appointmentTimeRequired_update">*</span></label>

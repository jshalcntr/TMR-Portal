    ...
    <?php if ($authRole == "S-ADMIN" || $authorizations['accounts_view']): ?>
        ...
        <div class="side-item">
            <ul class="<?= strpos($_SERVER['REQUEST_URI'], 'accounts.php') !== false ? 'active' : '' ?>">
                <li class="iso-pro">
                    <a href="/tmr-portal/views/s-admin/account-management/accounts.php">
                        <span></span>
                        <span></span>
                        <span></span>
    ...
    <div class="side-item">
        <ul class="<?= strpos($_SERVER['REQUEST_URI'], 'ticketing.php') !== false ? 'active' : '' ?>">
            <li class="iso-pro">
                ...
                <a href="<?= $authRole == "ADMIN" ? "/tmr-portal/views/admin/ticketing-system/ticketing.php" :
                            ($authRole == "USER" ? "/tmr-portal/views/user/ticketing-system/ticketing.php" :
                            ($authRole == "HEAD" ? "/tmr-portal/views/user/ticketing-system/ticketing.php" :

...
$(document).ready(function () {
            ...
            if (!this.checkValidity()) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "../../backend/inventory-management/editInventory.php",
                            data: formData,
                            success: function (response) {
    ...
    $("#retireInventoryButton").on('click', function () {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    type: "POST",
                    url: "../../backend/inventory-management/retireInventory.php",
                    data: {
                        id: queriedId
                    },
                    success: function (response) {
    ...
    $("#addToDisposalForm").on('submit', function (e) {
        ...
        $.ajax({
            type: "POST",
            url: "../../backend/inventory-management/disposeInventory.php",
            data: fullData,
            success: function (response) {
                if (response.status === 'success') {
                    Swal.fire({
